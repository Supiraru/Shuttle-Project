      ...
      <div class="flex justify-center">
            ...
            <div class="rounded rounded-t-lg border-4 overflow-hidden shadow w-1/3  my-3 ">
              ...
              <div class="flex justify-center pb-3 text-grey-dark">
                <div class="text-center mr-3 border-r pr-3">
                  <h2>{{ $user->following()->get()->count() }}</h2>
                  <span><a href="{{ route('user.following', $user->id) }}">Following</a></span>
                </div>
                <div class="text-center">
                  <h2>{{ $user->followers()->get()->count() }}</h2>
                <span>
                  <a href="{{ route('user.followers', $user->id) }}">Follower</a> </span>
              </div>
            </div>
          </div>
        </div>
        <div class="flex justify-center">
          ...
          <form action="{{ route('user.follow', $user->id) }}" method="post">
            @csrf
            <button class="shadow text-white bg-blue-600 font-semibold rounded-full hover:bg-blue-500 focus:shadow-outline focus:outline-none px-8 py-3" type="submit">
              Follow
            </button>
          </form>
          @else
          <form action="{{ route('user.unfollow', $user->id) }}" method="post">
            @csrf
            @method('DELETE')
            <button class="shadow text-white bg-gray-600 font-semibold rounded-full hover:bg-gray-500 focus:shadow-outline focus:outline-none px-8 py-3" type="submit">
              Unfollow
            </button>
          </form>
