...
@section('content')
    <div class="flex justify-center">
        <div class="w-8/12 bg-white p-6 rounded-lg">
          <p class="text-center mb-4 text-3xl font-bold text-gray-500">Home Timeline</p>
            @auth
            <form action="{{ route('posts') }}" method="post" enctype="multipart/form-data" class="mb-4">
              @csrf
              <div class="mb-4">
                  <label for="body" class="sr-only">Body</label>
                  <textarea name="caption" id="caption" cols="30" rows="4" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('caption') border-red-500 @enderror" placeholder="Post something!"></textarea>
